...
export function WhatsAppButton() {
    ...
    return (
        ...
        >
            ...
            <span className="absolute right-full mr-3 hidden whitespace-nowrap rounded-lg bg-white px-3 py-1 text-sm font-medium text-gray-900 shadow-md lg:block">
                {t('chatWithUs')}
            </span>
        </Link>
    );
